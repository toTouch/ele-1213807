...
@Slf4j
@Component
@JobHandler(value = "profitSharingOrderUnfreezeQueryTask")
public class ProfitSharingOrderUnfreezeQueryTask extends IJobHandler {
    ...
    public ReturnT<String> execute(String param) throws Exception {
        ...
        log.info("profit sharing order unfreeze query task execute start");
        ...
        log.info("profit sharing order unfreeze query task execute end");
