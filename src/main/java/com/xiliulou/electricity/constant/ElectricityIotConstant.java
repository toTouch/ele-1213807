...
public class ElectricityIotConstant {
    ...
    static {
         ...
         * 电池充电设置
         */
        COMMAND_HANDLER_MAPS.put(ELE_BATTERY_MULTI_PARAMS_READ, NORMAL_ELE_OPERATE_HANDLER);
        COMMAND_HANDLER_MAPS.put(ELE_BATTERY_MULTI_PARAMS_READ_RSP, NORMAL_ELE_OPERATE_HANDLER);
