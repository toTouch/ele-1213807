...
public interface MerchantPlaceFeeMonthRecordMapper {
    ...
    List<MerchantPlaceFeeMonthRecord> selectListBySettlementTime(@Param("date") String date, @Param("tenantId") Integer tenantId, @Param("franchiseeIds") List<Long> franchiseeIds);
