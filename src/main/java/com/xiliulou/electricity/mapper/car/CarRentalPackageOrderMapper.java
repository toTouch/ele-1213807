...
public interface CarRentalPackageOrderMapper {
     ...
     * @return 操作总条数
     */
    Integer updateStateByOrderNo(@Param("orderNo") String orderNo, @Param("payState") Integer payState, @Param("useState") Integer useState,
            @Param("useBeginTime") Long useBeginTime);
     ...
     * @return 操作总条数
     */
    int updatePayStateByOrderNo(@Param("orderNo") String orderNo, @Param("payState") Integer payState, @Param("remark") String remark, @Param("optUid") Long optUid,
    ...
    int updateUseStateByOrderNo(@Param("orderNo") String orderNo, @Param("useState") Integer useState, @Param("optUid") Long optUid, @Param("optTime") Long optTime,
            @Param("userBeginTime") Long userBeginTime);
