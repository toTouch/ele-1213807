...
public interface DivisionAccountConfigMapper extends BaseMapper<DivisionAccountConfig> {
    ...
    List<DivisionAccountConfigRefVO> selectDivisionAccountConfigWithPackage(@Param("packageType") Integer packageType, @Param("storeId") Long storeId, @Param("franchiseeId") Long franchiseeId, @Param("tenantId") Integer tenantId);
    ...
    List<SearchVo> configSearch(@Param("size") Long size, @Param("offset") Long offset, @Param("name") String name, @Param("tenantId") Integer tenantId,@Param("storeIds") List<Long> storeIds,@Param("franchiseeIds") List<Long> franchiseeIds);
}
