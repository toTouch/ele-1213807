...
public interface InvitationActivityRecordMapper extends BaseMapper<InvitationActivityRecord> {
    ...
    List<InvitationActivityRecord> selectByActivityIdAndUid(@Param("activityIds") List<Long> activityIds, @Param("uid") Long uid);
    ...
    List<InvitationActivityRecord> selectListByUidAndStartTime(@Param("uid")Long uid, @Param("startTime")Long startTime, @Param("endTime") Long endTime);
}
