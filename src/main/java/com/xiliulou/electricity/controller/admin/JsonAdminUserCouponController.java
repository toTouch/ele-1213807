...
public class JsonAdminUserCouponController {
    ...
    @PostMapping(value = "/admin/userCoupon/batchReleaseCoupon")
    @Log(title = "批量发放优惠券")
    public R batchReleaseCoupon(@RequestBody CouponBatchReleaseRequest request) {
        return userCouponService.adminBatchReleaseCoupon(request);
    }
