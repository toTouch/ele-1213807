...
public class JsonAdminUserInfoGroupController extends BasicController {
    ...
    public R save(@RequestBody @Validated(value = CreateGroup.class) UserInfoGroupSaveRequest userInfoGroupSaveRequest) {
        ...
        return userInfoGroupService.save(userInfoGroupSaveRequest, user.getUid());
    }
