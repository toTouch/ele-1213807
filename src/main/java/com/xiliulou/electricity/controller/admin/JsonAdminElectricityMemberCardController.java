...
public class JsonAdminElectricityMemberCardController {
    ...
    public R getElectricityMemberCardPage(@RequestParam(value = "offset") Long offset, @RequestParam(value = "size") Long size,
            @RequestParam(value = "type", required = false) Integer type, @RequestParam(value = "status", required = false) Integer status,
    ...
    public R getElectricityMemberCardPage(@RequestParam(value = "type", required = false) Integer type, @RequestParam(value = "status", required = false) Integer status,
            @RequestParam(value = "cardModel", required = false) Integer cardModel) {
    ...
    public R listByFranchisee(@RequestParam(value = "offset") Long offset, @RequestParam(value = "size") Long size, @RequestParam(value = "type", required = false) Integer type,
    ...
    public R listCountByFranchisee(@RequestParam(value = "type", required = false) Integer type, @RequestParam(value = "status", required = false) Integer status) {
    ...
    public R getElectricityUsableBatteryList(@PathVariable("id") Long id) {
        ...
        BatteryMemberCardQuery query = BatteryMemberCardQuery.builder().franchiseeId(id).delFlag(BatteryMemberCard.DEL_NORMAL).status(BatteryMemberCard.STATUS_UP)
