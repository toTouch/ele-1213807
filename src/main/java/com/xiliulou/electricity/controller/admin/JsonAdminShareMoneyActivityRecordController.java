...
public class JsonAdminShareMoneyActivityRecordController {
    ...
    public R queryList(@RequestParam("size") Long size, @RequestParam("offset") Long offset, @RequestParam(value = "uid", required = false) Long uid,
        ...
        ShareMoneyActivityRecordQuery shareMoneyActivityRecordQuery = ShareMoneyActivityRecordQuery.builder().offset(offset).size(size).phone(phone).name(name).uid(uid)
                .storeIds(storeIds).franchiseeIds(franchiseeIds).tenantId(TenantContextHolder.getTenantId()).franchiseeId(franchiseeId).build();
    ...
    public R queryCount(@RequestParam(value = "phone", required = false) String phone, @RequestParam(value = "uid", required = false) Long uid,
        ...
        ShareMoneyActivityRecordQuery shareMoneyActivityRecordQuery = ShareMoneyActivityRecordQuery.builder().phone(phone).name(name).uid(uid).storeIds(storeIds)
                .franchiseeIds(franchiseeIds).tenantId(TenantContextHolder.getTenantId()).franchiseeId(franchiseeId).build();
