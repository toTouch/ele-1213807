...
public class JsonAdminElectricityCabinetServerController {
    ...
    @DeleteMapping("admin/electricityCabinetServer/delete/{id}") public R deleteOne(@PathVariable("id") Long id) {
        return electricityCabinetServerService.deleteOne(id);
    }

    @PutMapping("admin/electricityCabinetServer/update") public R updateOne(@RequestParam(value = "id") Long id,
