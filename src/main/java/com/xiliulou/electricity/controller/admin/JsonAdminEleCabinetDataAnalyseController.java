...
public class JsonAdminEleCabinetDataAnalyseController extends BaseController {
    ...
    public R allPage(@RequestParam("size") long size, @RequestParam("offset") long offset, @RequestParam(value = "name", required = false) String name,
            @RequestParam(value = "sn", required = false) String sn, @RequestParam(value = "address", required = false) String address,
            @RequestParam(value = "franchiseeId", required = false) Long franchiseeId, @RequestParam(value = "orderByAverageNumber", required = false) Integer orderByAverageNumber,
            ...
            @RequestParam(value = "orderByTodayActivity", required = false) Integer orderByTodayActivity, @RequestParam(value = "storeId", required = false) Long storeId,
    ...
    public R allPageCount(@RequestParam(value = "name", required = false) String name, @RequestParam(value = "sn", required = false) String sn,
            @RequestParam(value = "address", required = false) String address, @RequestParam(value = "franchiseeId", required = false) Long franchiseeId,
            @RequestParam(value = "areaId", required = false) Long areaId, @RequestParam(value = "storeId", required = false) Long storeId) {
    ...
    public R offlinePage(@RequestParam("size") long size, @RequestParam("offset") long offset, @RequestParam(value = "name", required = false) String name,
            @RequestParam(value = "sn", required = false) String sn, @RequestParam(value = "address", required = false) String address,
            @RequestParam(value = "franchiseeId", required = false) Long franchiseeId, @RequestParam(value = "orderByAverageNumber", required = false) Integer orderByAverageNumber,
            @RequestParam(value = "orderByAverageActivity", required = false) Integer orderByAverageActivity,
            @RequestParam(value = "orderByTodayNumber", required = false) Integer orderByTodayNumber,
        ...
        ElectricityCabinetQuery cabinetQuery = ElectricityCabinetQuery.builder().size(size).offset(offset).onlineStatus(ElectricityCabinet.ELECTRICITY_CABINET_OFFLINE_STATUS)
                .areaId(areaId).sn(sn).address(address).franchiseeId(franchiseeId).storeId(storeId).name(name).tenantId(TenantContextHolder.getTenantId()).eleIdList(eleIdList)
    ...
    public R offlinePageCount(@RequestParam(value = "name", required = false) String name, @RequestParam(value = "sn", required = false) String sn,
            @RequestParam(value = "address", required = false) String address, @RequestParam(value = "franchiseeId", required = false) Long franchiseeId,
            @RequestParam(value = "areaId", required = false) Long areaId, @RequestParam(value = "storeId", required = false) Long storeId) {
        ...
        ElectricityCabinetQuery cabinetQuery = ElectricityCabinetQuery.builder().onlineStatus(ElectricityCabinet.ELECTRICITY_CABINET_OFFLINE_STATUS).areaId(areaId).sn(sn)
                .address(address).franchiseeId(franchiseeId).storeId(storeId).name(name).tenantId(TenantContextHolder.getTenantId()).statisticDate(timeAgoStartTime)
    ...
    public R disablePage(@RequestParam("size") long size, @RequestParam("offset") long offset, @RequestParam(value = "name", required = false) String name,
            @RequestParam(value = "sn", required = false) String sn, @RequestParam(value = "address", required = false) String address,
            @RequestParam(value = "franchiseeId", required = false) Long franchiseeId, @RequestParam(value = "orderByAverageNumber", required = false) Integer orderByAverageNumber,
            @RequestParam(value = "orderByAverageActivity", required = false) Integer orderByAverageActivity,
            @RequestParam(value = "orderByTodayNumber", required = false) Integer orderByTodayNumber,
    ...
    public R disablePageCount(@RequestParam(value = "name", required = false) String name, @RequestParam(value = "sn", required = false) String sn,
            @RequestParam(value = "address", required = false) String address, @RequestParam(value = "franchiseeId", required = false) Long franchiseeId,
            @RequestParam(value = "areaId", required = false) Long areaId, @RequestParam(value = "storeId", required = false) Long storeId) {
        ...
        ElectricityCabinetQuery cabinetQuery = ElectricityCabinetQuery.builder().sn(sn).address(address).name(name).areaId(areaId)
                .usableStatus(ElectricityCabinet.ELECTRICITY_CABINET_UN_USABLE_STATUS).tenantId(TenantContextHolder.getTenantId()).storeId(storeId).franchiseeId(franchiseeId)
                .statisticDate(timeAgoStartTime).eleIdList(eleIdList).build();
    ...
    public R lockPage(@RequestParam("size") long size, @RequestParam("offset") long offset, @RequestParam(value = "name", required = false) String name,
            @RequestParam(value = "sn", required = false) String sn, @RequestParam(value = "address", required = false) String address,
            @RequestParam(value = "franchiseeId", required = false) Long franchiseeId, @RequestParam(value = "orderByAverageNumber", required = false) Integer orderByAverageNumber,
            @RequestParam(value = "orderByAverageActivity", required = false) Integer orderByAverageActivity,
            @RequestParam(value = "orderByTodayNumber", required = false) Integer orderByTodayNumber,
        ...
        ElectricityCabinetQuery cabinetQuery = ElectricityCabinetQuery.builder().size(size).offset(offset).sn(sn).storeId(storeId).areaId(areaId)
    ...
    public R lockPageCount(@RequestParam(value = "name", required = false) String name, @RequestParam(value = "sn", required = false) String sn,
            @RequestParam(value = "address", required = false) String address, @RequestParam(value = "franchiseeId", required = false) Long franchiseeId,
            @RequestParam(value = "areaId", required = false) Long areaId, @RequestParam(value = "storeId", required = false) Long storeId) {
        //用户区分
        TokenUser user = SecurityUtils.getUserInfo();
        ...
        ElectricityCabinetQuery cabinetQuery = ElectricityCabinetQuery.builder().sn(sn).storeId(storeId).areaId(areaId)
                .usableStatusCell(ElectricityCabinetBox.ELECTRICITY_CABINET_BOX_UN_USABLE).address(address).franchiseeId(franchiseeId).name(name)
                .tenantId(TenantContextHolder.getTenantId()).statisticDate(timeAgoStartTime).eleIdList(eleIdList).build();
