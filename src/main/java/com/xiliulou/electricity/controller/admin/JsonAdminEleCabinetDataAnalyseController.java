...
public class JsonAdminEleCabinetDataAnalyseController extends BaseController {
    ...
    public R offlinePageCount(@RequestParam(value = "name", required = false) String name, @RequestParam(value = "sn", required = false) String sn,
        ...
        ElectricityCabinetQuery cabinetQuery = ElectricityCabinetQuery.builder().onlineStatus(ElectricityCabinet.ELECTRICITY_CABINET_OFFLINE_STATUS).sn(sn).address(address)
    ...
    public R lockPageCount(@RequestParam(value = "name", required = false) String name, @RequestParam(value = "sn", required = false) String sn,
        ...
        ElectricityCabinetQuery cabinetQuery = ElectricityCabinetQuery.builder().sn(sn).storeId(storeId).usableStatusCell(ElectricityCabinetBox.ELECTRICITY_CABINET_BOX_UN_USABLE)
                .address(address).franchiseeId(franchiseeId).name(name).tenantId(TenantContextHolder.getTenantId()).statisticDate(timeAgoStartTime).eleIdList(eleIdList).build();
