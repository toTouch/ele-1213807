...
public class JsonAdminSupperController {
    ...
    public R<DelBatteryVo> delBatterys(@RequestBody DelBatteryReq delBatteryReq) {
        Pair<List<String>, List<String>> pair = adminSupperService.delBatteryBySnList(delBatteryReq.getTenantId(),
                delBatteryReq.getBatterySnList(), delBatteryReq.getViolentDel());
    ...
    public R getElectricityMemberCardPage(@RequestParam("size") Long size, @RequestParam("offset") Long offset,
        ...
        MemberCardOrderQuery memberCardOrderQuery = MemberCardOrderQuery.builder().payType(payType).phone(phone)
                .orderId(orderId).cardType(cardType).queryStartTime(queryStartTime)
                .queryEndTime(queryEndTime).offset(offset).size(size).tenantId(tenantId).status(status).uid(uid)
                .useStatus(useStatus).source(source)
                .payType(payType).refId(refId).cardModel(memberCardModel).franchiseeId(franchiseeId).franchiseeIds(null)
                .storeIds(null).cardPayCount(payCount)
    ...
    public R queryCount(@RequestParam(value = "phone", required = false) String phone,
        ...
        MemberCardOrderQuery memberCardOrderQuery = MemberCardOrderQuery.builder().payType(payType).phone(phone)
                .orderId(orderId).cardType(cardType).queryStartTime(queryStartTime)
                .queryEndTime(queryEndTime).status(status).uid(uid).useStatus(useStatus).source(source).payType(payType)
                .refId(refId)
                .cardModel(memberCardModel).franchiseeId(franchiseeId).franchiseeIds(null).storeIds(null)
                .cardPayCount(payCount).userName(userName).payType(payType).tenantId(tenantId)
                .cardId(cardId).build();
    ...
    public R queryListSuper(@RequestParam("size") Long size, @RequestParam("offset") Long offset,
        ...
        ElectricityCabinetQuery electricityCabinetQuery = ElectricityCabinetQuery.builder().offset(offset).size(size)
                .areaId(areaId).name(name).address(address).tenantId(tenantId)
                .usableStatus(usableStatus).stockStatus(stockStatus).warehouseId(warehouseId).onlineStatus(onlineStatus)
                .beginTime(beginTime).endTime(endTime).eleIdList(null)
    ...
    public R queryCountSuper(@RequestParam(value = "name", required = false) String name,
        ...
        ElectricityCabinetQuery electricityCabinetQuery = ElectricityCabinetQuery.builder().name(name).address(address)
                .areaId(areaId).usableStatus(usableStatus).tenantId(tenantId)
                .onlineStatus(onlineStatus).stockStatus(stockStatus).warehouseId(warehouseId).beginTime(beginTime)
                .endTime(endTime).eleIdList(null).build();
    ...
    public R page(@RequestParam("size") long size, @RequestParam("offset") long offset,
        ...
        BatteryMemberCardQuery query = BatteryMemberCardQuery.builder().size(size).offset(offset).tenantId(tenantId)
                .id(mid).franchiseeId(franchiseeId)
                .status(status).businessType(businessType == null ? 0 : businessType).rentType(rentType)
                .rentUnit(rentUnit).name(name).delFlag(BatteryMemberCard.DEL_NORMAL)
                .franchiseeIds(null).batteryModel(batteryModel)
    ...
    public R pageCount(@RequestParam(value = "franchiseeId", required = false) Long franchiseeId,
        ...
        BatteryMemberCardQuery query = BatteryMemberCardQuery.builder().franchiseeId(franchiseeId).status(status)
                ...
                .rentType(rentType).rentUnit(rentUnit).name(name).tenantId(tenantId)
                .delFlag(BatteryMemberCard.DEL_NORMAL).franchiseeIds(null)
    ...
    public R getElectricityMemberCardPage(@RequestParam("size") long size, @RequestParam("offset") long offset,
        ...
        BatteryMembercardRefundOrderQuery query = BatteryMembercardRefundOrderQuery.builder().uid(uid).phone(phone)
                .refundOrderNo(refundOrderNo).startTime(beginTime)
                .endTime(endTime).offset(offset).size(size).rentType(rentType).tenantId(tenantId).status(status)
                .franchiseeIds(null)
    ...
    public R queryCount(@RequestParam(value = "uid", required = false) Long uid,
        ...
        BatteryMembercardRefundOrderQuery query = BatteryMembercardRefundOrderQuery.builder().uid(uid).phone(phone)
                .refundOrderNo(refundOrderNo).startTime(beginTime)
                .endTime(endTime).tenantId(tenantId).status(status).rentType(rentType).payType(payType)
                .franchiseeIds(null).storeIds(null)
                .mid(mid).build();
    ...
    public R queryList(@RequestParam("size") Long size, @RequestParam("offset") Long offset,
        ...
        EleRefundQuery eleRefundQuery = EleRefundQuery.builder().offset(offset).size(size).orderId(orderId)
                .status(status).beginTime(beginTime).endTime(endTime)
                .tenantId(tenantId).storeIds(null).franchiseeIds(null).phone(phone).uid(uid).payType(payType)
    ...
    public R queryCount(@RequestParam(value = "orderId", required = false) String orderId,
        ...
        EleRefundQuery eleRefundQuery = EleRefundQuery.builder().orderId(orderId).status(status).storeIds(null)
                .franchiseeIds(null).payType(payType)
                .refundOrderType(refundOrderType).beginTime(beginTime).endTime(endTime).tenantId(tenantId).phone(phone)
                .uid(uid).orderType(orderType)
    ...
    public R getElectricityDisableMemberCardList(@RequestParam(value = "offset") Long offset,
        ...
        ElectricityMemberCardRecordQuery electricityMemberCardRecordQuery = ElectricityMemberCardRecordQuery.builder()
                .offset(offset).size(size).franchiseeIds(null)
                .storeIds(null).disableMemberCardNo(disableMemberCardNo).phone(phone).status(status).uid(uid)
    ...
    public R getElectricityDisableMemberCardCount(
        ...
        ElectricityMemberCardRecordQuery electricityMemberCardRecordQuery = ElectricityMemberCardRecordQuery.builder()
                .disableMemberCardNo(disableMemberCardNo).phone(phone)
                .status(status).uid(uid).franchiseeIds(null).storeIds(null).beginTime(beginTime).endTime(endTime)
                .tenantId(tenantId).build();
    ...
    public R queryList(@RequestParam("size") Long size, @RequestParam("offset") Long offset,
        ...
        EnableMemberCardRecordQuery enableMemberCardRecordQuery = EnableMemberCardRecordQuery.builder()
                .enableType(enableType).beginTime(beginTime).endTime(endTime).offset(offset)
                .size(size).phone(phone).franchiseeIds(null).storeIds(null).userName(userName).uid(uid)
                .tenantId(tenantId).disableMemberCardNo(disableMemberCardNo)
    ...
    public R queryCount(@RequestParam(value = "userName", required = false) String userName,
        ...
        EnableMemberCardRecordQuery enableMemberCardRecordQuery = EnableMemberCardRecordQuery.builder()
                .enableType(enableType).beginTime(beginTime).endTime(endTime).phone(phone)
                .franchiseeIds(null).storeIds(null).userName(userName).uid(uid).tenantId(tenantId)
    ...
    public R queryList(@RequestParam("size") Long size, @RequestParam("offset") Long offset,
        ...
        EleDepositOrderQuery eleDepositOrderQuery = EleDepositOrderQuery.builder().offset(offset).size(size).name(name)
                .phone(phone).uid(uid).beginTime(beginTime).endTime(endTime)
                .status(status).orderId(orderId).storeIds(null).tenantId(tenantId).carModel(carModel)
                .franchiseeName(franchiseeName)
                .depositType(depositType).payType(payType).storeName(storeName).franchiseeIds(null).orderType(orderType)
                .build();
    ...
    public R queryCount(@RequestParam(value = "status", required = false) Integer status,
        ...
        EleDepositOrderQuery eleDepositOrderQuery = EleDepositOrderQuery.builder().name(name).phone(phone).uid(uid)
                .beginTime(beginTime).endTime(endTime).status(status)
                .orderId(orderId).storeIds(null).carModel(carModel).depositType(depositType).payType(payType)
                .storeName(storeName).tenantId(tenantId)
