...
public class JsonAdminSupperController {
    ...
    public R clearUserDelMark(@RequestBody ClearUserDelMarkRequest clearUserDelMarkParam) {
        return userDelRecordService.adminClearUserDelMark(clearUserDelMarkParam);
    }
    ...
    public R getElectricityMemberCardPage(@RequestParam("size") Long size, @RequestParam("offset") Long offset,
        ...
        MemberCardOrderQuery memberCardOrderQuery = MemberCardOrderQuery.builder().payType(payType).phone(phone).orderId(orderId).cardType(cardType).queryStartTime(queryStartTime)
                .queryEndTime(queryEndTime).offset(offset).size(size).tenantId(tenantId).status(status).uid(uid).useStatus(useStatus).source(source).payType(payType).refId(refId)
                .cardModel(memberCardModel).franchiseeId(franchiseeId).franchiseeIds(null).storeIds(null).cardPayCount(payCount).userName(userName).payType(payType).cardId(cardId)
                .build();
    ...
    public R queryCount(@RequestParam(value = "phone", required = false) String phone, @RequestParam(value = "orderId", required = false) String orderId,
        ...
        MemberCardOrderQuery memberCardOrderQuery = MemberCardOrderQuery.builder().payType(payType).phone(phone).orderId(orderId).cardType(cardType).queryStartTime(queryStartTime)
                .queryEndTime(queryEndTime).status(status).uid(uid).useStatus(useStatus).source(source).payType(payType).refId(refId).cardModel(memberCardModel)
                .franchiseeId(franchiseeId).franchiseeIds(null).storeIds(null).cardPayCount(payCount).userName(userName).payType(payType).tenantId(tenantId).cardId(cardId).build();
    ...
    public R queryListSuper(@RequestParam("size") Long size, @RequestParam("offset") Long offset, @RequestParam(value = "name", required = false) String name,
        ...
        ElectricityCabinetQuery electricityCabinetQuery = ElectricityCabinetQuery.builder().offset(offset).size(size).areaId(areaId).name(name).address(address).tenantId(tenantId)
                ...
                .id(id).deviceName(deviceName).build();
    ...
    public R page(@RequestParam("size") long size, @RequestParam("offset") long offset, @RequestParam(value = "franchiseeId", required = false) Long franchiseeId,
        ...
        BatteryMemberCardQuery query = BatteryMemberCardQuery.builder().size(size).offset(offset).tenantId(tenantId).id(mid).franchiseeId(franchiseeId).status(status)
                .businessType(businessType == null ? 0 : businessType).rentType(rentType).rentUnit(rentUnit).name(name).delFlag(BatteryMemberCard.DEL_NORMAL).franchiseeIds(null)
    ...
    public R pageCount(@RequestParam(value = "franchiseeId", required = false) Long franchiseeId, @RequestParam(value = "status", required = false) Integer status,
        ...
        BatteryMemberCardQuery query = BatteryMemberCardQuery.builder().franchiseeId(franchiseeId).status(status).businessType(businessType == null ? 0 : businessType)
                .rentType(rentType).rentUnit(rentUnit).name(name).tenantId(tenantId).delFlag(BatteryMemberCard.DEL_NORMAL).franchiseeIds(null).batteryModel(batteryModel)
    ...
    public R querySuperList(@RequestParam("size") Long size, @RequestParam("offset") Long offset, @RequestParam(value = "status", required = false) String status,
            ...
            @RequestParam(value = "tenantId", required = false) Integer tenantId, @RequestParam(value = "isFreeze", required = false) Integer isFreeze) {
        if (size < 0 || size > 50) {
            size = 10L;
        }
    ...
    public R getElectricityMemberCardPage(@RequestParam("size") long size, @RequestParam("offset") long offset, @RequestParam(value = "uid", required = false) Long uid,
        ...
        BatteryMembercardRefundOrderQuery query = BatteryMembercardRefundOrderQuery.builder().uid(uid).phone(phone).refundOrderNo(refundOrderNo).startTime(beginTime)
                .endTime(endTime).offset(offset).size(size).rentType(rentType).tenantId(tenantId).status(status).franchiseeIds(null).storeIds(null).mid(mid).payType(payType)
                .build();
    ...
    public R queryCount(@RequestParam(value = "uid", required = false) Long uid, @RequestParam(value = "phone", required = false) String phone,
        ...
        BatteryMembercardRefundOrderQuery query = BatteryMembercardRefundOrderQuery.builder().uid(uid).phone(phone).refundOrderNo(refundOrderNo).startTime(beginTime)
                .endTime(endTime).tenantId(tenantId).status(status).rentType(rentType).payType(payType).franchiseeIds(null).storeIds(null).mid(mid).build();
    ...
    public R queryList(@RequestParam("size") Long size, @RequestParam("offset") Long offset, @RequestParam(value = "franchiseeName", required = false) String franchiseeName,
        ...
        EleRefundQuery eleRefundQuery = EleRefundQuery.builder().offset(offset).size(size).orderId(orderId).status(status).beginTime(beginTime).endTime(endTime).tenantId(tenantId)
                .storeIds(null).franchiseeIds(null).phone(phone).uid(uid).payType(payType).refundOrderType(refundOrderType).name(name).orderType(orderType)
    ...
    public R queryCount(@RequestParam(value = "orderId", required = false) String orderId, @RequestParam(value = "status", required = false) Integer status,
        ...
        EleRefundQuery eleRefundQuery = EleRefundQuery.builder().orderId(orderId).status(status).storeIds(null).franchiseeIds(null).payType(payType)
                .refundOrderType(refundOrderType).beginTime(beginTime).endTime(endTime).tenantId(tenantId).phone(phone).uid(uid).orderType(orderType).refundOrderNo(refundOrderNo)
                .build();
    ...
    public R getElectricityDisableMemberCardList(@RequestParam(value = "offset") Long offset, @RequestParam(value = "size") Long size,
        ...
        ElectricityMemberCardRecordQuery electricityMemberCardRecordQuery = ElectricityMemberCardRecordQuery.builder().offset(offset).size(size).franchiseeIds(null).storeIds(null)
                .disableMemberCardNo(disableMemberCardNo).phone(phone).status(status).uid(uid).beginTime(beginTime).endTime(endTime).tenantId(tenantId).build();
    ...
    public R queryCount(@RequestParam(value = "userName", required = false) String userName, @RequestParam(value = "phone", required = false) String phone,
        ...
        EnableMemberCardRecordQuery enableMemberCardRecordQuery = EnableMemberCardRecordQuery.builder().enableType(enableType).beginTime(beginTime).endTime(endTime).phone(phone)
                .franchiseeIds(null).storeIds(null).userName(userName).uid(uid).tenantId(tenantId).disableMemberCardNo(disableMemberCardNo).beginDisableTime(beginDisableTime)
    ...
    public R queryList(@RequestParam("size") Long size, @RequestParam("offset") Long offset, @RequestParam(value = "franchiseeName", required = false) String franchiseeName,
        ...
        EleDepositOrderQuery eleDepositOrderQuery = EleDepositOrderQuery.builder().offset(offset).size(size).name(name).phone(phone).uid(uid).beginTime(beginTime).endTime(endTime)
                .status(status).orderId(orderId).storeIds(null).tenantId(tenantId).carModel(carModel).franchiseeName(franchiseeName).depositType(depositType).payType(payType)
                .storeName(storeName).franchiseeIds(null).orderType(orderType).build();
    ...
    public R queryCount(@RequestParam(value = "status", required = false) Integer status, @RequestParam(value = "name", required = false) String name,
        ...
        EleDepositOrderQuery eleDepositOrderQuery = EleDepositOrderQuery.builder().name(name).phone(phone).uid(uid).beginTime(beginTime).endTime(endTime).status(status)
                .orderId(orderId).storeIds(null).carModel(carModel).depositType(depositType).payType(payType).storeName(storeName).tenantId(tenantId).franchiseeName(franchiseeName)
                .franchiseeIds(null).orderType(orderType).build();
    ...
    public R queryList(@RequestParam("offset") Long offset, @RequestParam("size") Long size, @RequestParam(value = "beginTime", required = false) Long beginTime,
            @RequestParam(value = "endTime", required = false) Long endTime, @RequestParam(value = "uid", required = false) Long uid,
            @RequestParam(value = "name", required = false) String name, @RequestParam(value = "orderId", required = false) String orderId,
            @RequestParam(value = "phone", required = false) String phone, @RequestParam(value = "status", required = false) Integer status,
            @RequestParam(value = "source", required = false) Integer source, @RequestParam(value = "payTimeBegin", required = false) Long payTimeBegin,
        ...
        BatteryServiceFeeQuery batteryServiceFeeQuery = BatteryServiceFeeQuery.builder().uid(uid).beginTime(beginTime).endTime(endTime).offset(offset).size(size).name(name)
                .orderId(orderId).status(status).tenantId(tenantId).franchiseeIds(null).storeIds(null).source(source).phone(phone).payTimeBegin(payTimeBegin).payTimeEnd(payTimeEnd)
                .orderByServiceFeeGenerateTime(orderByServiceFeeGenerateTime).orderByPayTime(orderByPayTime).build();
    ...
    public R queryCount(@RequestParam(value = "beginTime", required = false) Long beginTime, @RequestParam(value = "endTime", required = false) Long endTime,
            ...
            @RequestParam(value = "orderId", required = false) String orderId, @RequestParam(value = "phone", required = false) String phone,
            @RequestParam(value = "status", required = false) Integer status, @RequestParam(value = "source", required = false) Integer source,
            @RequestParam(value = "payTimeBegin", required = false) Long payTimeBegin, @RequestParam(value = "payTimeEnd", required = false) Long payTimeEnd,
            @RequestParam(value = "tenantId", required = false) Integer tenantId) {
        ...
        BatteryServiceFeeQuery batteryServiceFeeQuery = BatteryServiceFeeQuery.builder().uid(uid).beginTime(beginTime).endTime(endTime).status(status).name(name).orderId(orderId)
                .tenantId(tenantId).franchiseeIds(null).storeIds(null).source(source).phone(phone).payTimeBegin(payTimeBegin).payTimeEnd(payTimeEnd).build();
        
        return eleBatteryServiceFeeOrderService.countTotalForSuperAdmin(batteryServiceFeeQuery);
    }
    
    @GetMapping("/electricityCabinet/onlineLogList")
    ...
    @GetMapping("/electricityCabinet/onlineLogCount")
