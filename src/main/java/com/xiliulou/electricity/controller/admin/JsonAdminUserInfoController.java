...
public class JsonAdminUserInfoController extends BaseController {
    ...
    public R queryList(@RequestParam("size") Long size, @RequestParam("offset") Long offset, @RequestParam(value = "name", required = false) String name,
            ...
            @RequestParam(value = "authStatus", required = false) Integer authStatus, @RequestParam(value = "serviceStatus", required = false) Integer serviceStatus,
            @RequestParam(value = "batteryRentStatus", required = false) Integer batteryRentStatus,
            @RequestParam(value = "batteryDepositStatus", required = false) Integer batteryDepositStatus, @RequestParam(value = "franchiseeId", required = false) Long franchiseeId,
            @RequestParam(value = "uid", required = false) Long uid, @RequestParam(value = "memberCardId", required = false) Long memberCardId,
            @RequestParam(value = "cardName", required = false) String cardName, @RequestParam(value = "sortType", required = false) Integer sortType,
        ...
        UserInfoQuery userInfoQuery = UserInfoQuery.builder().offset(offset).size(size).name(name).phone(phone).batteryId(batteryId).franchiseeId(franchiseeId)
                .authStatus(authStatus).serviceStatus(serviceStatus).memberCardExpireTimeBegin(memberCardExpireTimeBegin).memberCardExpireTimeEnd(memberCardExpireTimeEnd)
                .carMemberCardExpireType(carMemberCardExpireType).carMemberCardExpireTimeBegin(carMemberCardExpireTimeBegin).carMemberCardExpireTimeEnd(carMemberCardExpireTimeEnd)
                .uid(uid).sortType(sortType).cardPayCount(cardPayCount).memberCardId(memberCardId).cardName(cardName).memberCardExpireType(memberCardExpireType)
                .batteryRentStatus(batteryRentStatus).batteryDepositStatus(batteryDepositStatus).franchiseeIds(franchiseeIds).storeIds(storeIds)
                .userCreateBeginTime(userCreateBeginTime).userCreateEndTime(userCreateEndTime).tenantId(TenantContextHolder.getTenantId()).build();
    ...
    public void exportExcel(@RequestParam(value = "name", required = false) String name, @RequestParam(value = "phone", required = false) String phone,
            @RequestParam(value = "nowElectricityBatterySn", required = false) String nowElectricityBatterySn,
            @RequestParam(value = "authStatus", required = false) Integer authStatus, @RequestParam(value = "batteryId", required = false) Long batteryId,
            @RequestParam(value = "serviceStatus", required = false) Integer serviceStatus, @RequestParam(value = "batteryRentStatus", required = false) Integer batteryRentStatus,
            @RequestParam(value = "batteryDepositStatus", required = false) Integer batteryDepositStatus, @RequestParam(value = "franchiseeId", required = false) Long franchiseeId,
            @RequestParam(value = "uid", required = false) Long uid, @RequestParam(value = "memberCardId", required = false) Long memberCardId,
            @RequestParam(value = "sortType", required = false) Integer sortType, @RequestParam(value = "cardName", required = false) String cardName,
            @RequestParam(value = "cardPayCount", required = false) Integer cardPayCount,
            @RequestParam(value = "memberCardExpireType", required = false) Integer memberCardExpireType,
            @RequestParam(value = "userCreateBeginTime", required = false) Long userCreateBeginTime,
            @RequestParam(value = "userCreateEndTime", required = false) Long userCreateEndTime,
        ...
        UserInfoQuery userInfoQuery = UserInfoQuery.builder().name(name).phone(phone).nowElectricityBatterySn(nowElectricityBatterySn).franchiseeId(franchiseeId)
                .authStatus(authStatus).serviceStatus(serviceStatus).batteryRentStatus(batteryRentStatus).batteryDepositStatus(batteryDepositStatus).sortType(sortType)
                .batteryId(batteryId).memberCardExpireType(memberCardExpireType).memberCardExpireTimeBegin(memberCardExpireTimeBegin)
                .memberCardExpireTimeEnd(memberCardExpireTimeEnd).carMemberCardExpireType(carMemberCardExpireType).carMemberCardExpireTimeBegin(carMemberCardExpireTimeBegin)
                .carMemberCardExpireTimeEnd(carMemberCardExpireTimeEnd).uid(uid).memberCardId(memberCardId).cardName(cardName).cardPayCount(cardPayCount)
                .userCreateBeginTime(userCreateBeginTime).userCreateEndTime(userCreateEndTime).tenantId(TenantContextHolder.getTenantId()).build();
    ...
    public R queryCount(@RequestParam(value = "name", required = false) String name, @RequestParam(value = "phone", required = false) String phone,
            ...
            @RequestParam(value = "userCreateEndTime", required = false) Long userCreateTimeEnd, @RequestParam(value = "batteryId", required = false) Long batteryId,
            @RequestParam(value = "uid", required = false) Long uid, @RequestParam(value = "batteryRentStatus", required = false) Integer batteryRentStatus,
            @RequestParam(value = "batteryDepositStatus", required = false) Integer batteryDepositStatus, @RequestParam(value = "cardName", required = false) String cardName,
            @RequestParam(value = "memberCardId", required = false) Long memberCardId, @RequestParam(value = "cardPayCount", required = false) Integer cardPayCount,
            @RequestParam(value = "authType", required = false) Integer authType, @RequestParam(value = "sortType", required = false) Integer sortType,
            @RequestParam(value = "authStatus", required = false) Integer authStatus, @RequestParam(value = "serviceStatus", required = false) Integer serviceStatus) {
        ...
        UserInfoQuery userInfoQuery = UserInfoQuery.builder().name(name).phone(phone).memberCardExpireTimeBegin(memberCardExpireTimeBegin)
                .memberCardExpireTimeEnd(memberCardExpireTimeEnd).carMemberCardExpireType(carMemberCardExpireType).carMemberCardExpireTimeBegin(carMemberCardExpireTimeBegin)
                .carMemberCardExpireTimeEnd(carMemberCardExpireTimeEnd).cardName(cardName).uid(uid).batteryId(batteryId).memberCardId(memberCardId).authStatus(authStatus)
                .authType(authType).sortType(sortType).serviceStatus(serviceStatus).batteryRentStatus(batteryRentStatus).batteryDepositStatus(batteryDepositStatus)
                .cardPayCount(cardPayCount).memberCardExpireType(memberCardExpireType).franchiseeIds(franchiseeIds).storeIds(storeIds).userCreateBeginTime(userCreateTimeBegin)
                .userCreateEndTime(userCreateTimeEnd).tenantId(TenantContextHolder.getTenantId()).build();
    ...
    public R queryAuthenticationCount(@RequestParam(value = "name", required = false) String name, @RequestParam(value = "phone", required = false) String phone,
            @RequestParam(value = "memberCardExpireTimeBegin", required = false) Long memberCardExpireTimeBegin,
            @RequestParam(value = "memberCardExpireTimeEnd", required = false) Long memberCardExpireTimeEnd,
    ...
    public void exportCarRentalExcel(@RequestParam(value = "uid", required = false) Long uid, @RequestParam(value = "sortType", required = false) Integer sortType,
        ...
        UserInfoQuery userInfoQuery = UserInfoQuery.builder().carMemberCardExpireType(carRentalExpireType).carMemberCardExpireTimeBegin(carRentalExpireTimeBegin)
                .carMemberCardExpireTimeEnd(carRentalExpireTimeEnd).uid(uid).sortType(sortType).sortBy(sortBy).franchiseeIds(franchiseeIds).storeIds(storeIds)
    ...
    public R queryCarRentalList(@RequestParam("size") Long size, @RequestParam("offset") Long offset, @RequestParam(value = "uid", required = false) Long uid,
    ...
    public R queryEleList(@RequestParam("size") Long size, @RequestParam("offset") Long offset, @RequestParam(value = "uid", required = false) Long uid,
        ...
        UserInfoQuery userInfoQuery = UserInfoQuery.builder().offset(offset).size(size).memberCardExpireTimeBegin(memberCardExpireTimeBegin)
                ...
                .franchiseeIds(franchiseeIds).storeIds(storeIds).sortBy(sortBy).sortType(sortType).name(name).phone(phone).tenantId(TenantContextHolder.getTenantId()).build();
