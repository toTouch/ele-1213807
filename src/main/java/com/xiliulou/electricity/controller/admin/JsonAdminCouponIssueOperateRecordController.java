...
public class JsonAdminCouponIssueOperateRecordController {
    ...
    public R queryList(@RequestParam("size") Long size, @RequestParam("offset") Long offset, @RequestParam(value = "couponId", required = false) Integer couponId,
        ...
        CouponIssueOperateRecordQuery couponIssueOperateRecordQuery = CouponIssueOperateRecordQuery.builder().couponId(couponId).phone(phone).name(name).status(status)
                .beginTime(beginTime).endTime(endTime).offset(offset).size(size).tenantId(tenantId).build();
    ...
    public R queryCount(@RequestParam(value = "couponId", required = false) Integer couponId, @RequestParam(value = "phone", required = false) String phone,
            @RequestParam(value = "name", required = false) String name, @RequestParam(value = "status", required = false) Integer status,
