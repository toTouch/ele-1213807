...
public class JsonAdminJoinShareActivityHistoryController {
    ...
    public R joinActivity(@RequestParam("size") Long size, @RequestParam("offset") Long offset, @RequestParam("id") Long id,
        ...
        JsonShareActivityHistoryQuery jsonShareActivityHistoryQuery = JsonShareActivityHistoryQuery.builder().offset(offset).size(size).tenantId(tenantId).id(id).joinName(joinName)
                .status(status).startTime(beginTime).endTime(endTime).franchiseeIds(franchiseeIds).franchiseeId(franchiseeId).build();
    ...
    public R joinActivityCount(@RequestParam("id") Long id, @RequestParam(value = "joinName", required = false) String joinName,
        ...
        JsonShareActivityHistoryQuery jsonShareActivityHistoryQuery = JsonShareActivityHistoryQuery.builder().tenantId(TenantContextHolder.getTenantId()).id(id).joinName(joinName)
                .status(status).startTime(beginTime).endTime(endTime).franchiseeIds(franchiseeIds).franchiseeId(franchiseeId).build();
    ...
    public R participationList(@RequestParam("size") Long size, @RequestParam("offset") Long offset, @RequestParam(value = "joinName", required = false) String joinName,
        ...
        JsonShareActivityHistoryQuery jsonShareActivityHistoryQuery = JsonShareActivityHistoryQuery.builder().offset(offset).size(size).tenantId(TenantContextHolder.getTenantId())
                .joinName(joinName).phone(joinPhone).joinUid(joinUid).activityName(activityName).status(status).startTime(beginTime).endTime(endTime).storeIds(storeIds)
    ...
    public R participationCount(@RequestParam(value = "joinName", required = false) String joinName, @RequestParam(value = "joinPhone", required = false) String joinPhone,
        ...
        JsonShareActivityHistoryQuery jsonShareActivityHistoryQuery = JsonShareActivityHistoryQuery.builder().tenantId(TenantContextHolder.getTenantId()).joinName(joinName)
                .phone(joinPhone).joinUid(joinUid).activityName(activityName).status(status).startTime(beginTime).endTime(endTime).storeIds(storeIds).franchiseeIds(franchiseeIds)
    ...
    public void joinActivityExportExcel(@RequestParam("id") Long id, @RequestParam(value = "joinName", required = false) String joinName,
            @RequestParam(value = "beginTime", required = false) Long beginTime, @RequestParam(value = "endTime", required = false) Long endTime,
