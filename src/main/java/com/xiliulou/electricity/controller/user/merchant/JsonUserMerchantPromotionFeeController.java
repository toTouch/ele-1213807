...
public class JsonUserMerchantPromotionFeeController {
    ...
    @GetMapping("/user/merchant/promotion/home")
    public R queryPromotionFeeHome(@RequestParam("type") Integer type, @RequestParam("uid") Long uid) {
        ...
        return merchantPromotionFeeService.queryPromotionFeeHome(type, uid);
    }
