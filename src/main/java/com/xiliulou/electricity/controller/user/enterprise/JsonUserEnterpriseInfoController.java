...
public class JsonUserEnterpriseInfoController extends BaseController {
    ...
    public R queryPurchasePackageCount() {
        ...
        EnterprisePurchaseOrderQuery query = EnterprisePurchaseOrderQuery.builder().enterpriseId(enterpriseInfo.getId()).tenantId(tenantId).currentTime(System.currentTimeMillis())
                .build();
