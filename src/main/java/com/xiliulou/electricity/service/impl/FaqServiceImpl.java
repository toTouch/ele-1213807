...
public class FaqServiceImpl implements FaqService {
    ...
    public Faq queryByIdFromDB(Integer id) {
        return this.faqMapper.queryById(id);
    }
     ...
     */
    @Override
    public Faq queryByIdFromCache(Integer id) {
        return null;
    }
     ...
     */
    @Override
    public List<Faq> queryAllByLimit(int offset, int limit) {
        return this.faqMapper.queryAllByLimit(offset, limit);
    }
    ...
    public Integer update(Faq faq) {
        return this.faqMapper.update(faq);
