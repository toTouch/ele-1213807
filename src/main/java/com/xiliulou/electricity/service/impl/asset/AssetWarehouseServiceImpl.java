...
public class AssetWarehouseServiceImpl implements AssetWarehouseService {
    ...
    public R save(AssetWarehouseSaveRequest assetWarehouseSaveRequest) {
        ...
        AssetWarehouse assetWarehouse = AssetWarehouse
                .builder()
                .name(assetWarehouseSaveRequest.getName())
                .status(assetWarehouseSaveRequest.getStatus())
                .managerName(assetWarehouseSaveRequest.getManagerName())
                .managerPhone(assetWarehouseSaveRequest.getManagerPhone())
                .address(assetWarehouseSaveRequest.getAddress())
                .delFlag(AssetWarehouse.DEL_NORMAL)
