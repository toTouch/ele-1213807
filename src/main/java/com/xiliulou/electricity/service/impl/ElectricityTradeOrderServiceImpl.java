...
public class ElectricityTradeOrderServiceImpl extends ServiceImpl<ElectricityTradeOrderMapper, ElectricityTradeOrder> implements ElectricityTradeOrderService {
    ...
    public Pair<Boolean, Object> notifyMemberOrder(BaseOrderCallBackResource callBackResource) {
        ...
        if (Objects.equals(memberOrderStatus, EleDepositOrder.STATUS_SUCCESS)) {
            ...
            electricityMemberCardOrderService.handlerBatteryMembercardPaymentNotify(batteryMemberCard, electricityMemberCardOrder,
                    userBatteryMemberCardService.selectByUidFromCache(electricityMemberCardOrder.getUid()), userInfo);
            ...
            if (Objects.equals(userBatteryMemberCard.getMemberCardStatus(), UserBatteryMemberCard.MEMBER_CARD_DISABLE)) {
                ...
                if (Objects.isNull(enableMemberCardRecord)) {
                    EnableMemberCardRecord enableMemberCardRecordInsert = EnableMemberCardRecord.builder().disableMemberCardNo(eleDisableMemberCardRecord.getDisableMemberCardNo())
                            ...
                            .serviceFee(eleBatteryServiceFeeOrder.getBatteryServiceFee()).createTime(System.currentTimeMillis()).tenantId(userInfo.getTenantId())
                            .uid(userInfo.getUid()).userName(userInfo.getName()).orderId(userBatteryMemberCard.getOrderId()).updateTime(System.currentTimeMillis()).build();
