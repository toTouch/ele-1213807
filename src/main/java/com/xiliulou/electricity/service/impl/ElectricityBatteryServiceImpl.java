...
/*        String sn = electricitybatterymapper.querySnByUid(uid);
    ...
    @Slave
    @Override
    public Map<Long, String> listUserBatteryByUidList(List<Long> uidList, Integer tenantId) {
        ...
        Map<Long, String> userBatteryMap = new HashMap<>(listMap.size());
        listMap.forEach((uid, batteryList) -> {
            ...
            if (Objects.nonNull(battery)) {
                userBatteryMap.put(uid, battery.getSn());
            }
        });
