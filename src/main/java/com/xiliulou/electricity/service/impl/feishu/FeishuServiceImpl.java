...
import com.xiliulou.electricity.config.feishu.FeishuConfig;
...
public class FeishuServiceImpl implements FeishuService {
    ...
    public void sendException(String requestURI, String traceId, Exception e) {
        ...
        try {
            HttpUtil.post(StringUtils.isNotBlank(feishuConfig.getSaasFeishuRobotUrl()) ? feishuConfig.getSaasFeishuRobotUrl() : CommonConstant.FEISHU_WARNING_ROBOT_WEB_HOOK_URL, JSONObject.toJSONString(paramMap));
        } catch (Exception ex) {
