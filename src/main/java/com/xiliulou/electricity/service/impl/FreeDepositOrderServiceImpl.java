...
public class FreeDepositOrderServiceImpl implements FreeDepositOrderService {
    ...
    public Triple<Boolean, String, Object> synchronizFreeDepositOrderStatus(String orderId) {
        ...
        //租车免押订单
        if (Objects.equals(freeDepositOrder.getDepositType(), FreeDepositOrder.DEPOSIT_TYPE_CAR) || Objects.equals(freeDepositOrder.getDepositType(), FreeDepositOrder.DEPOSIT_TYPE_CAR_BATTERY)) {
            // 查询押金缴纳信息
    ...
    public Triple<Boolean, String, Object> freeBatteryDepositOrder(FreeBatteryDepositQuery freeBatteryDepositQuery) {
        ...
        redisService.saveWithString(CacheConstant.ELE_CACHE_BATTERY_FREE_DEPOSIT_ORDER_GENERATE_LOCK_KEY + uid, UriUtils.encode(callPxzRsp.getData(),StandardCharsets.UTF_8), 300 * 1000L, false);
