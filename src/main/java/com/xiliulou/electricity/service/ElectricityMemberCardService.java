...
public interface ElectricityMemberCardService {
    ...
    R queryList(Long offset, Long size, Integer status, Integer type,Integer tenantId,Integer cardModel);
	...
	R queryCount(Integer status, Integer type, Integer tenantId,Integer cardModel);
