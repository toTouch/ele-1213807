...
public interface CarRentalPackageOrderBizService {
     ...
     * @return
     */
    Boolean freezeRentOrder(Integer tenantId, Long uid, String packageOrderNo, Integer applyTerm, String applyReason, SystemDefinitionEnum systemDefinitionEnum);
