...
public interface InstallmentBizService {
     ...
     * @return 同步结果
     */
    R<Object> queryDeductStatus(String payNo);
     ...
     * @return 代扣调用结果
     */
    R<String> deduct(List<InstallmentDeductionPlan> deductionPlans);
     ...
     */
    void handleAgreementPaySuccess(InstallmentDeductionRecord deductionRecord, String tradeNo);
     ...
     * @return 调起结果
     */
    Triple<Boolean, String, Object> initiatingDeduct(List<InstallmentDeductionPlan> deductionPlans, InstallmentRecord installmentRecord, FyConfig fyConfig);
