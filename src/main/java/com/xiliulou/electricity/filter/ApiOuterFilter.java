 ...
 */
@Slf4j
public abstract class ApiOuterFilter implements Filter {
    
    private RequestMatcher requiresAuthenticationRequestMatcher;
    
    
    public ApiOuterFilter(RequestMatcher requiresAuthenticationRequestMatcher) {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain)
        ...
        try {
            ...
            String signature = SignUtils.getSignature(apiRequestQuery.getAppId(), apiRequestQuery.getRequestTime(),
                    apiRequestQuery.getRequestId(), apiRequestQuery.getVersion(), tenantAppInfo.getAppsecert());
